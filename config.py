...
OWNER_ID = int(getenv("6646084739"))
MONGO_URL = getenv("MONGO_URL")
BOT_TOKEN = getenv("6812674130:AAGqzNI5DuPZjD8GxUE-qmM0PTRna-rpXHY", "")
ALIVE_PIC = getenv("ALIVE_PIC", 'https://telegra.ph/file/3feb34601b53ecdfd79ea.jpg')
ALIVE_TEXT = getenv("I'm Sasha")
PM_LOGGER = getenv("PM_LOGGER")
LOG_GROUP = getenv("-1002052301233")
GIT_TOKEN = getenv("GIT_TOKEN") #personal access token
REPO_URL = getenv("REPO_URL", "https://github.com/l85zk/ZAID-USERBOT")
BRANCH = getenv("BRANCH", "master") #don't change
 
STRING_SESSION1 = getenv("1BJWap1wBu0FRaUvP7bJg9Wl10oO67mm-sP9TOXYAh00ioAbxwWBycRipEki_hC5Kn8ck8QxTa-smWmKR0mquVihyRj8o6zLEBrKj_YhQXL8lQCVfhMO1pMW5pL8yWRxwFZv5vrz-i9OJVbmxwDghbxKh6mTRGfSrmwDI89_drFNKTbPaqHGQZ0u3Yq_tEUuc-m7eWjGbR52pDy1O_ulvHujG5OIweG6jdSqNNLCsyOMdbxQeE0jjyz3u5LJPo_8YjjyDFMy-No2VKyaSSw8Xp9VW8xc1UUJy6qB_46fudmLoTCDBLOWaLBBnuKRYk0555jq4Vn-MzdJeU12KJ1nQuFpKA6Khgo0=", "")
